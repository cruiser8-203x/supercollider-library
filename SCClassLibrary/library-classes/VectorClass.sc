VectorClass : RectangleClass{
	 ...
	 *new { arg view,xloc,yloc,width,height,color,grid;
		^super.new.init(view,xloc,yloc,width,height,color,grid);
		...
		view.mouseDownAction = { |view,mouse_x,mouse_y|
			  ...
			  if(this.grid.actionTypeForMusicNote==1,
			  {
				//MusicNote.removeAll;
			     ...
			     this.grid.addPointToSelectionArray(this);
				//MusicNote.addToPointCollection(this);
			  ...
			  },
			  {
				 ...
				 this.musicNoteObj = VectorClass.new(
						this.parentview,
				 ...
				 this.grid.deselectAll;
				 this.grid.addPointToSelectionArray(musicNoteObj);
				 this.grid.addToPointCollection(musicNoteObj);
